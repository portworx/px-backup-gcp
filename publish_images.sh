...
SCHEDULER_SOURCE=registry.k8s.io/kube-scheduler-amd64:${KUBE_VERSION}
publish_image ${SCHEDULER_SOURCE} ${KUBE_VERSION} ${PRODUCT_NAME}/kube-scheduler-amd64

CONTROLLER_MANAGER_SOURCE=registry.k8s.io/kube-controller-manager-amd64:${KUBE_VERSION}
