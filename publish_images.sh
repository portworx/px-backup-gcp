STORK_VERSION=25.1.0
KUBE_VERSION=v1.30.0
GCR_REPO=portworx-public
DEPLOYER_MINOR_VERSION=2.8
DEPLOYER_PATCH_VERSION=2.8.3
...
PXCENTRAL_ONPREM_API_TAG=2.8.3
...
PXCENTRAL_ONPREM_UI_FRONTEND_TAG=2.8.3
...
PXCENTRAL_ONPREM_UI_BACKEND_TAG=2.8.3
...
PXCENTRAL_ONPREM_UI_LHBACKEND_TAG=2.8.3
...
PXCENTRAL_ONPREM_POST_SETUP_TAG=2.8.3
...
POSTGRESQL_TAG=16.6.0-debian-12-r2
...
KEYCLOAK_LOGIN_THEME_TAG=2.8.0
...
MONGODB_TAG=5.0.24-debian-11-r20
...
MONGODB_TAG=7.0.15-debian-12-r2
MONGODB=portworx/mongodb:${MONGODB_TAG}
publish_image ${MONGODB} ${MONGODB_TAG} ${PRODUCT_NAME}/mongodb

PRE_UPGRADE_HOOK_TAG=2.8.3
PRE_UPGRADE_HOOK=portworx/pxcentral-onprem-hook:${PRE_UPGRADE_HOOK_TAG}
publish_image ${PRE_UPGRADE_HOOK} ${PRE_UPGRADE_HOOK_TAG} ${PRODUCT_NAME}/pxcentral-onprem-hook
...
PXBACKUP_PROMETHEUS_TAG=v2.35.0
...
PXBACKUP_ALERTMANAGER_TAG=v0.28.0
...
PXBACKUP_PROMETHEUS_OPERATOR_TAG=v0.79.2
...
PXBACKUP_PROMETHEUS_CONFIG_RELOADER_TAG=v0.79.2
